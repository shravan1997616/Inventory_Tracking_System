...
import com.nitc.lab.dao.AdminDao;
...
public class AdminLoginSer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminLoginSer</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            Admin admin = dao.getAdminIdAndPassword(id, pass);
...
//                login success
                ...
                response.sendRedirect("AdminWork.jsp");

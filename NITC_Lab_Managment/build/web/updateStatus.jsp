...
<!--        navbar-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="checkRequest.jsp" > <span class="fa fa-address-card-o"></span> Check Request <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#System_update"> <span class="fa fa-address-card-o"></span> Update Status</a>
            </li>
...
<div class="modal fade" id="System_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update system status......</h5>
      ...
      <div class="modal-body">
          ...
          <form id="add-request" action="systemUpdateSer" method="post">

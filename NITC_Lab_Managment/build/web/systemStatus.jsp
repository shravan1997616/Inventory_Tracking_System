...
<%@page import="com.nitc.lab.dao.SystemDao"%>
...
<%@page import="com.nitc.lab.entities.System"%>
...
<!--                <a class="nav-link" href="systemStatus.jsp"> <span class="fa fa-address-card-o"></span>System Status</a>-->
                <a class="nav-link" href="#" data-toggle="modal" data-target="#System_status"> <span class="fa fa-address-card-o"></span> System Status <span class="sr-only">(current)</span></a>
            </li>
            
            <li class="nav-item active">
                
                <a class="nav-link" href="LabInchargeWork.jsp"> <span class="fa fa-bell-o"></span> View Complaints</a>
            </li>
...
<div class="modal fade" id="System_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Display system status......</h5>
      ...
      <div class="modal-body">
          <div class="row">
          <%
              SystemDao d = new SystemDao(ConnectionProvider.getConnection());
              List<System> compl = d.getAllSystem(labincharge.getLab());
              for(System p : compl){
                  %>
                  <div class="col-md-6 mt-2">
                      <div class="card">
                          <div class="card-body">
                              <b><%="System Id : "+p.getId()%></b><br>
                              <b><%="Operating System : "+p.getOper()%></b><br>
                              <b><%="Lab name : "+p.getLab()%></b><br>
                              <b><%="System Status: "+p.getStatus()%></b><br>

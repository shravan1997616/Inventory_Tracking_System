    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#labincharg_notification"> <span class="fa fa-bell-o"></span> View Complaints <span class="sr-only">(current)</span></a>
            </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Display all Student complain notification......</h5>
      ...
      <div class="modal-body">
          ...
          <%
              ...
              List<StudentCompl> compl = d.getAllComplien(labincharge.getLab());
                  ...
                  <div class="col-md-12 mt-2">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <b><%="Complain Status : "+p.getStatus()%></b><br><br>

...
<!--        navbar-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="modal" data-target="#labincharg_request"> <span class="fa fa-address-card-o"></span> Request</a>
            </li>
            <li class="nav-item">
...
<main>
<div class="modal fade" id="labincharg_request" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Provide System Request...</h5>
      ...
      <div class="modal-body">
          ...
          <form id="add-request" action="labinchaRequestSer" method="post">
              <div class="form-group">
                  <input type="text" name="scom" placeholder="Enter Student Complain no." class="form-control"/>
              </div>
              <div class="form-group">
                  <input type="text" name="sno" placeholder="Enter System No." class="form-control"/>
              </div>
              
              <div class="form-group">
                  <input type="text" name="title" placeholder="Enter Request Title" class="form-control"/>
              </div>
              
              <div class="form-group">
                  <textarea class="form-control" name="mess" style="height:300px;" placeholder="Enter Your Request Message"></textarea>
              </div>

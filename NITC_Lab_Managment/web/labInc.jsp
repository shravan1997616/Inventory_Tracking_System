                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card">
                        <div class="card-header text-center primary-background text-white">
                            ...
                            <br>
                            Labincharge Register here
                        </div>
                        <div class="card-body">
                            <form id="reg-form" action="labInchReg" method="POST">

                                <div class="form-group">
                                    <label for="user_name">LabIncharge Name</label>
                                ...
                                <div class="form-group">
                                    <select required="required" class="form-control" name="lab" id="lab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  name="reg" required="required" type="text" class="form-control" id="exampleInputID" placeholder="Enter Registration no">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputPassword1">Password</label>
                                    <input  name="pass" required="required" type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter Password">
                                </div>
